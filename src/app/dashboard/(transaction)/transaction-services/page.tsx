...
export const metadata: Metadata = {
  title: "Transaksi Layanan - Just Code In Web",
}
...
export default function TransactionService() {
    return (
        <div className="text-black">
            <div className="mb-4">
                <h1 className="text-2xl font-bold tracking-widest">Transaksi Layanan</h1>
            </div>
            <div className="mb-4 rounded shadow-xl">
                <div className="p-4">
                    <h1 className="text-lg font-bold tracking-widest mb-4">List Transaksi</h1>
